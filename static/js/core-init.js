...
class BRCookiebar {
  ...
  constructor({ name, component, json, lang, mode = 'default', callback }) {
    this.name = name
    this.component = component
    this.data = new _cookiebar_data__WEBPACK_IMPORTED_MODULE_0__.CookiebarData(json, lang)
    this.templates = new _cookiebar_templates__WEBPACK_IMPORTED_MODULE_1__.CookiebarTemplates(this.data)
    this.mode = mode
  ...
  _setAcceptButtonBehavior() {
    const acceptButton = this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_2__.ACCEPT_BUTTON)
  ...
  _setPoliticsButtonBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.POLITICS_BUTTON).forEach((politicsButton) => {
      // Expande o cookiebar
  ...
  _setCloseButtonBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.CLOSE_BUTTON).forEach((closeButton) => {
      ...
      closeButton.addEventListener('click', () => {
        ...
        this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_2__.POLITICS_BUTTON).classList.remove('d-none')
        document.body.style.overflowY = 'auto'
  ...
  _setWindowResizeBehavior() {
    window.addEventListener('resize', () => {
      ...
      this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.ACTION_BUTTONS).forEach((button) => {
  ...
  _setToggleGroupBehavior() {
    this.component
      .querySelectorAll(
        `${`${_selectors__WEBPACK_IMPORTED_MODULE_2__.GROUP_BUTTON}, ${_selectors__WEBPACK_IMPORTED_MODULE_2__.GROUP_NAME}, ${_selectors__WEBPACK_IMPORTED_MODULE_2__.COOKIES_CHECKED}, ${_selectors__WEBPACK_IMPORTED_MODULE_2__.GROUP_SIZE}`}`
      )
      .forEach((clickable) => {
  ...
  _handleToggleGroupClick(event) {
    ...
    if (element.classList.contains('open')) {
      ...
      element.nextElementSibling.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.BR_SWITCH).forEach((check) => {
  ...
  _setCheckboxBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.PARENT_CHECKBOX).forEach((trigger) => {
  ...
  _setSelectionBehavior() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.CHECKBOX).forEach((checkbox) => {
  ...
  _displayBroadAlertMessage() {
    this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.BROAD_ALERT).forEach((broadAlert) => {
  ...
  _displayGroupAlertMessage(groupIndex) {
    const group = this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.GROUP_INFO)[groupIndex]
    group.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.GROUP_ALERT).forEach((groupAlert) => {
      if (
  ...
  _displayCookieAlertMessage(groupIndex, cookieIndex) {
    const group = this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.GROUP_INFO)[groupIndex]
    const cookie = group.nextElementSibling.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.COOKIE_CARD)[cookieIndex]
    cookie.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.COOKIE_ALERT).forEach((cookieAlert) => {
      if (
  ...
  _toggleIcon(element, oldIcon, newIcon) {
    element.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.BUTTON_ICON).forEach((icon) => {
  ...
  _scrollUp(element) {
    setTimeout(() => {
      this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.WRAPPER).forEach(() => {
        setTimeout(() => {
  ...
  _showCookiebar() {
    ...
    switch (this.mode) {
      case 'open':
        this.component.classList.remove('default')
        this.component.querySelectorAll(_selectors__WEBPACK_IMPORTED_MODULE_2__.POLITICS_BUTTON).forEach((button) => {
   ...
   */
  _setOpenView() {
    const wrapper = this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_2__.WRAPPER)
    const containerFluid = this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_2__.CONTAINER_FLUID)
    const modalFooter = this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_2__.MODAL_FOOTER)
   ...
   */
  _setDefaultView() {
    this.component.querySelector(_selectors__WEBPACK_IMPORTED_MODULE_2__.WRAPPER).removeAttribute('style')
  }
...
/***/ "./src/components/cookiebar/jsonData.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (jsonData);
...
class BRTable {
  ...
  _searchBehavior() {
    if (this.component.dataset.search) {
      ...
      if (trigger && target && dismiss && inputField) {
        // Inicializar
        ...
        console.error('Um ou mais elementos necessários para a busca não foram encontrados.')
      }
    }
  }
...
// EXTERNAL MODULE: ./src/components/cookiebar/jsonData.js
var jsonData = __webpack_require__("./src/components/cookiebar/jsonData.js");
